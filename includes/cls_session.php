 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: cls_session.php 17217 2011-01-19 06:29:08Z pangbin $
*/
...
class cls_session
{
    ...
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'HHS_ID', $session_id = '')
    {
        $this->cls_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'HHS_ID', $session_id = '')
    {
