...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/yunda_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.hhshop.com';
...
class yunda_express
{
    ...
    {
        $form_str = '<a href="http://ykjcx.yundasys.com/go.php?wen=' .$invoice_sn. '" target="_blank">' .$invoice_sn. '</a>';
