...
/**
 * 小舍电商 SQL语句执行类。在调用该类方法之前，请参看相应方法的说明。
 *
 * ============================================================================
 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: cls_sql_executor.php 17217 2014-05-12 06:29:08Z pangbin $
 */
...
class sql_executor
{
     ...
     * @return  void
     */
    function __construct($db, $charset = 'gbk', $sprefix = 'hhs_', $tprefix = 'hhs_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'gbk', $sprefix = 'hhs_', $tprefix = 'hhs_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
