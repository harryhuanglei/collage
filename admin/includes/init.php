...
if (!file_exists('../temp/compiled/admin_m'))
{
    @mkdir('../temp/compiled/admin_m', 0777);
    @chmod('../temp/compiled/admin_m', 0777);
}
...
$smarty->compile_dir   = ROOT_PATH . 'temp/compiled/admin_m';
if ((DEBUG_MODE & 2) == 2)
{
