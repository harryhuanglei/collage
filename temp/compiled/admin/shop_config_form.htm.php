      <tr>
          <td colspan="2" class="required"><label><?php echo $this->_var['var']['name']; ?>:</label></td>
      </tr>
      ...
      <tr class="noborder">
        <td class="rowform">
          ...
          <textarea name="value[<?php echo $this->_var['var']['id']; ?>]" rows="6" class="tarea"><?php echo $this->_var['var']['value']; ?></textarea>
...
?>
          ...
          <?php if (( $this->_var['var']['code'] == "shop_logo" || $this->_var['var']['code'] == "no_picture" || $this->_var['var']['code'] == "watermark" || $this->_var['var']['code'] == "shop_slagon" || $this->_var['var']['code'] == "wap_logo" || $this->_var['var']['code'] == "share_bg" || $this->_var['var']['code'] == "business_login_logo" || $this->_var['var']['code'] == "business_logo" ) && $this->_var['var']['value']): ?>
...
?>
        ...
        <td class="tips"><span class="vatop rowform" id="notice<?php echo $this->_var['var']['code']; ?>"><?php if ($this->_var['var']['desc']): ?><?php echo nl2br($this->_var['var']['desc']); ?><?php endif; ?></span></td>
      </tr>
