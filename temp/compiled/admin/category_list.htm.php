...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  <tr>
    <th align="center"><?php echo $this->_var['lang']['cat_name']; ?></th>
    <th align="center"><?php echo $this->_var['lang']['is_show']; ?></th>
    <th align="center"><?php echo $this->_var['lang']['sort_order']; ?></th>
...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>"<?php if ($this->_var['cat']['level'] > 0): ?> style="display:none;"<?php endif; ?>>
    ...
    <td width="10%" align="center"><img src="images/<?php if ($this->_var['cat']['is_show'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_is_show', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
    <td width="10%" align="center"><span onclick="listTable.edit(this, 'edit_sort_order', <?php echo $this->_var['cat']['cat_id']; ?>)"><?php echo $this->_var['cat']['sort_order']; ?></span></td>
    <td width="24%" align="center" class="bnt_a">
