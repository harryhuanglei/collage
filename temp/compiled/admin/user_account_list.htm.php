...
?>
  <tr>
    ...
    <td align="center"><?php echo $this->_var['item']['surplus_amount']; ?></td>
    <td align="center"><?php if ($this->_var['item']['payment']): ?><?php echo $this->_var['item']['payment']; ?><?php else: ?>N/A<?php endif; ?></td>
    ...
    <!--a href="user_account.php?act=edit&id=<?php echo $this->_var['item']['id']; ?>" title="<?php echo $this->_var['lang']['surplus']; ?>">修改</a--><font style="color:#F00;">已完成</font>
    <?php else: ?>
    <a href="user_account.php?act=check&id=<?php echo $this->_var['item']['id']; ?>" title="<?php echo $this->_var['lang']['check']; ?>">审核</a>
    <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['item']['id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['drop']; ?>" ><?php echo $this->_var['lang']['drop']; ?></a>
    <?php endif; ?>
    </td>
  </tr>
  <?php endforeach; else: ?>
