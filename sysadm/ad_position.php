 ...
 * $Id: ad_position.php 17217 2014-05-12 06:29:08Z pangbin $
...
$exc = new exchange($hhs->table("ad_position"), $db, 'position_id', 'position_name');
...

{
    ...
    $smarty->assign('action_link', array('text' => '广告位置添加', 'href' => 'ad_position.php?act=add'));
...

{
...

    {
        ...
        $sql = 'INSERT INTO '.$hhs->table('ad_position').' (position_name, ad_width, ad_height, position_desc, position_style) '.
...

{
    ...
    $sql = 'SELECT * FROM ' .$hhs->table('ad_position'). " WHERE position_id='$id'";
...

{
    ...
    $sql = 'SELECT COUNT(*) FROM ' .$hhs->table('ad_position').
...

    {
        ...
        $sql = "UPDATE " .$hhs->table('ad_position'). " SET ".
...

{
    ...
    if ($ad_height > 10240 || $ad_height < 1)
...

{
    ...
    $sql = "SELECT COUNT(*) FROM " .$GLOBALS['hhs']->table('ad'). " WHERE position_id = '$id'";
...

{
    ...
    $sql = 'SELECT COUNT(*) FROM ' . $GLOBALS['hhs']->table('ad_position');
