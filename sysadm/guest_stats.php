 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: guest_stats.php 17217 2014-05-12 06:29:08Z pangbin $
*/
...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 有过订单的会员数 */
    $sql = 'SELECT COUNT(DISTINCT user_id) FROM ' .$hhs->table('order_info').
    ...
    {
        $filename = hhs_iconv(EC_CHARSET, 'GB2312', $_LANG['guest_statistics']);
