 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: sale_general.php 17217 2014-05-12 06:29:08Z pangbin $
*/
...
elseif ($_REQUEST['act'] == 'download')
{
    ...
    /* 文件标题 */
    echo hhs_iconv(EC_CHARSET, 'GB2312', $filename . $_LANG['sales_statistics']) . "\t\n";

    /* 订单数量, 销售出商品数量, 销售金额 */
    echo hhs_iconv(EC_CHARSET, 'GB2312', $_LANG['period']) ."\t";
    echo hhs_iconv(EC_CHARSET, 'GB2312', $_LANG['order_count_trend']) ."\t";
    echo hhs_iconv(EC_CHARSET, 'GB2312', $_LANG['order_amount_trend']) . "\t\n";

    foreach ($data_list AS $data)
    {
        echo hhs_iconv(EC_CHARSET, 'GB2312', $data['period']) . "\t";
        echo hhs_iconv(EC_CHARSET, 'GB2312', $data['order_count']) . "\t";
        echo hhs_iconv(EC_CHARSET, 'GB2312', $data['order_amount']) . "\t";
        echo "\n";
    }
}
