 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: users_order.php 17217 2014-05-12 06:29:08Z pangbin $
*/
 ...
 */
 ...
 {
    global $db, $hhs, $start_date, $end_date;
    ...
    $sql = "SELECT count(distinct(u.user_id)) FROM " .$hhs->table('users')." AS u, ".$hhs->table('order_info')." AS o " .$where;
    ...
    $sql = "SELECT u.user_id, u.user_name, COUNT(*) AS order_num, " .$total_fee.
               "FROM ".$hhs->table('users')." AS u, ".$hhs->table('order_info')." AS o " .$where .
