 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: priv_action.php 17217 2014-05-12 06:29:08Z pangbin $
*/
/* 权限管理的一级分组 */
$_LANG['goods'] = '商品管理';
...
$_LANG['sup_manage'] = '商家管理';
$_LANG['ad_manage'] = '广告管理';
$_LANG['system_set'] = '系统设置';
//商品管理部分的权限
...
$_LANG['point_order_view'] = '自提订单';
//促销管理
$_LANG['snatch_manage'] = '夺宝奇兵';
$_LANG['bonus_manage'] = '优惠劵管理';
$_LANG['card_manage'] = '祝福贺卡';
$_LANG['luck_manage'] = '抽奖管理';
$_LANG['pack'] = '商品包装';
$_LANG['ad_manage'] = '广告管理';
...
$_LANG['exchange_manage'] = '积分商品添加\修改';
$_LANG['exchange_remove'] = '积分商品移除';
$_LANG['bonus_change'] = '优惠券添加\修改';
$_LANG['bonus_remove'] = '优惠券移除';
$_LANG['bonus_send'] = '优惠券发放';
$_LANG['distribution_manage'] = '微信抢红包';
$_LANG['distribution_change'] = '微信红包添加';
$_LANG['distribution_remove'] = '微信红包移除';
...
//商家管理
$_LANG['suppliers_add_manage']  = '商家的添加\编辑';
$_LANG['suppliers_remove']  = '商家移除';
$_LANG['suppliers_accounts']  = '商家结算';
$_LANG['suppliers_list']  = '商家列表';
$_LANG['sup_list_down']  = '商家列表导出';
//广告管理权限
$_LANG['ad_position']  = '广告位置';
$_LANG['ad_add']  = '广告添加\编辑';
$_LANG['ads_list']  = '广告列表';
$_LANG['ad_remove']  = '广告移除';
//系统设置
$_LANG['shop_cfg'] = '商店设置';
$_LANG['site_cfg']  = '站点管理';
$_LANG['hangye_list']  = '行业管理';
$_LANG['pay_ment']  = '支付方式';
$_LANG['shipping_cfg']  = '配送方式';
$_LANG['areas_manage']  = '地区列表';
//微信权限
$_LANG['wx_jk'] = '微信接口';
$_LANG['wx_set']  = '微信设置';
$_LANG['wx_hf']  = '关注回复内容';
$_LANG['wx_kw']  = '关键词自动回复';
$_LANG['wx_menu']  = '自定义菜单';
$_LANG['wx_bonus']  = '关注送优惠券';
$_LANG['wx_share']  = '分享数据统计';
//商品品牌
$_LANG['brand_add']  = '商品品牌添加\编辑';
$_LANG['brand_remove']  = '商品品牌删除';
//用户评论
$_LANG['user_comment']  = '用户评论';
$_LANG['goods_remove']  = '商品回收';
$_LANG['square']  = '广场';
?>