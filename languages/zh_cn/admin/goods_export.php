...
// 批量上传商品的字段
$_LANG['export_hhshop'] = '导出到ECShop数据格式';
$_LANG['hhshop']['goods_name'] = '商品名称';
$_LANG['hhshop']['goods_sn'] = '商品货号';
$_LANG['hhshop']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['hhshop']['market_price'] = '市场售价';
$_LANG['hhshop']['shop_price'] = '本店售价';
$_LANG['hhshop']['integral'] = '积分购买额度';
$_LANG['hhshop']['original_img'] = '商品原始图';
$_LANG['hhshop']['goods_img'] = '商品图片';
$_LANG['hhshop']['goods_thumb'] = '商品缩略图';
$_LANG['hhshop']['keywords'] = '商品关键词';
$_LANG['hhshop']['goods_brief'] = '简单描述';
$_LANG['hhshop']['goods_desc'] = '详细描述';
$_LANG['hhshop']['goods_weight'] = '商品重量（kg）';
$_LANG['hhshop']['goods_number'] = '库存数量';
$_LANG['hhshop']['warn_number'] = '库存警告数量';
$_LANG['hhshop']['is_best'] = '是否精品';
$_LANG['hhshop']['is_new'] = '是否新品';
$_LANG['hhshop']['is_hot'] = '是否热销';
$_LANG['hhshop']['is_on_sale'] = '是否上架';
$_LANG['hhshop']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['hhshop']['is_real'] = '是否实体商品';
