...
$_LANG['user_bonus'] = "用户优惠劵";
$_LANG['user_bonus_info'] = '共计 %d 个,价值 %s';
$_LANG['not_bonus'] = '没有优惠劵';
$_LANG['add_user_bonus'] = '添加一个优惠劵';
$_LANG['bonus_number'] = '优惠劵序列号';
$_LANG['old_password'] = '原密码';
$_LANG['new_password'] = '新密码';
$_LANG['confirm_password'] = '确认密码';

$_LANG['bonus_sn_exist'] = '此优惠劵号码已经被占用了！';
$_LANG['bonus_sn_not_exist'] = '此优惠劵号码不存在！';
$_LANG['add_bonus_sucess'] = '添加新的优惠劵操作成功！';
$_LANG['add_bonus_false'] = '添加新的优惠劵操作失败！';
...
//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = '请输入您要添加的优惠劵号码！';
$_LANG['profile_js']['bonus_sn_error'] = '您输入的优惠劵号码格式不正确！';
...
/* 会员优惠劵 */
$_LANG['bonus_is_used'] = '你输入的优惠劵你已经领取过了！';
$_LANG['bonus_is_used_by_other'] = '你输入的优惠劵已经被其他人领取！';
$_LANG['bonus_add_success'] = '您已经成功的添加了一个新的优惠劵！';
$_LANG['bonus_not_exist'] = '你输入的优惠劵不存在';
$_LANG['user_bonus_empty'] = '您现在还没有优惠劵';
$_LANG['add_bonus_sucess'] = '添加新的优惠劵操作成功！';
$_LANG['add_bonus_false'] = '添加新的优惠劵操作失败！';
$_LANG['bonus_add_expire'] = '该优惠劵已经过期！';
$_LANG['bonus_use_expire'] = '该优惠劵已经过了使用期！';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、优惠劵等）以第二个为准。';
$_LANG['subtotal'] = '小计';
...
/* 优惠劵详情 */
$_LANG['bonus_sn'] = '优惠劵序号';
$_LANG['bonus_name'] = '优惠劵名称';
$_LANG['bonus_amount'] = '优惠劵金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['bonus_end_date'] = '截至使用日期';
$_LANG['bonus_status'] = "优惠劵状态";
