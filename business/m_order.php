...
elseif (@$_REQUEST['act'] == 'operate_post')
{
    ...
    elseif ('split' == $operation)
    {
      ...
      //  $delivery['update_time'] = GMTIME_UTC;
        ...
        {
            /* 操作失败 */
            $links = 'suppliers.php?op=order&act=order_info&order_id=' . $order_id;
            show_message($_LANG['act_false'], '返回', $links);
        }
